...
function model_init(){
	...
	model_renderer = setupRenderer(document.getElementById('model_container'));
...
function cut_init(){
	...
	cut_renderer = setupRenderer(document.getElementById('cut_container'));
