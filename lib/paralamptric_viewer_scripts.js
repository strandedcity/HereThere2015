...
function drawModelGeometry(solar_tilt,lamp_height,draw_construction){
	...
	drawMesh(model_scene,head_extrusion,skin_color,true);
	drawMesh(model_scene,neck_extrusion,skin_color,true);
	drawMesh(model_scene,body_extrusion,skin_color,true);
	drawMesh(model_scene,belly_extrusion,skin_color,true);
	drawMesh(model_scene,tail_extrusion,skin_color,true);
	...
	drawMesh(model_scene,rib_extrusion,skin_color,false);
...
function drawMesh(scene,geometry,color,flip){
	// var material = new THREE.MeshBasicMaterial({color:new THREE.Color(color),side:THREE.DoubleSide});
...
function moveGeometry(geometry,movement){
	geometry.applyMatrix( new THREE.Matrix4().makeTranslation( movement[0],movement[1],movement[2] ) );
}
