...
function drawModelGeometry(solar_tilt,lamp_height,draw_construction){
	...
	drawMesh(model_scene,extrudePiece(head,SKIN_WIDTH,extrusion_direction,true),skin_color,true);
	drawMesh(model_scene,extrudePiece(neck,SKIN_WIDTH,extrusion_direction,true),skin_color,true);
	drawMesh(model_scene,extrudePiece(body,SKIN_WIDTH,extrusion_direction,true),skin_color,true);
	drawMesh(model_scene,extrudePiece(belly,SKIN_WIDTH,extrusion_direction,true),skin_color,true);
	drawMesh(model_scene,extrudePiece(tail,SKIN_WIDTH,extrusion_direction,true),skin_color,true);
	...
	drawMesh(model_scene,rib,skin_color,true);
