...
function drawModelGeometry(solar_tilt,lamp_height,draw_construction){
	...
	var skin_color = "gray";
	drawMesh(model_scene,extrudePiece(head,extrusion_distance,extrusion_direction,true),skin_color);
	drawMesh(model_scene,extrudePiece(neck,extrusion_distance,extrusion_direction,true),skin_color);
	drawMesh(model_scene,extrudePiece(body,extrusion_distance,extrusion_direction,true),skin_color);
	drawMesh(model_scene,extrudePiece(belly,extrusion_distance,extrusion_direction,true),skin_color);
	drawMesh(model_scene,extrudePiece(tail,extrusion_distance,extrusion_direction,true),skin_color);
