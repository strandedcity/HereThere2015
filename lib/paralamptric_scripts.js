...
function updateSheets(){
	...
	for (var i = 0; i < sheets.length; i++){
		$("#sheet_list").append("<p align='left'>Sheet "+sheets[i].id+": "+Math.floor(sheet_width/12).toString()+"\' "+(sheet_width%12).toString()+"\" x "+Math.floor(sheet_height/12).toString()+"\' "+(sheet_height%12).toString()+"\"</p><a class='close_button' data-index='"+i+"'></a>");
	}
}
