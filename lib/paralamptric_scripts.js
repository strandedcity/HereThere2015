...
function setupGeometry(){
	...
	var neck = getArcByPoints(neckCircle_center,neckCircle_radius,topOfBody_pt,topOfNeck_pt);
	...
	var belly = getArcByPoints(bellyCircle_center,bellyCircle_radius,topOfBelly_pt,bottomOfBelly_pt,true);
	
	var throat_fillet = .75;
	...
	fillet(upperThroat,lowerThroat,throat_fillet);
	...
	fillet(upperBack,lowerBack,back_fillet);
	
	var neck_geometry = curveToGeometry(neck);
	var belly_geometry = curveToGeometry(belly);
	joinCurves([head,neck_geometry,body,belly_geometry,tail]);
...
function fillet(line1,line2,t){
	...
	arc = getArcByPoints(cPt,r, pt1,pt2);
...
function getArcByPoints(cPt,r,pt1,pt2,changeDirection){
	...
	return getArcByAngles(cPt,r,theta1,theta2,clockwise,WHITE);
}
...
function getFilletSegments(line1,line2,pt1,pt2){
	...
	var segment1 = getLineByPoints(sPt1,pt1,WHITE);
	var segment2 = getLineByPoints(sPt2,pt2,WHITE);
	drawLine(segment1,WHITE);
	drawLine(segment2,WHITE);
